...
>
> 🎁 **Bonus:** registering via [`dashboard.aro.network/signup?referral=C8RS`](https://dashboard.aro.network/signup?referral=C8RS) grants a **+20% daily mining boost for 14 days**.
